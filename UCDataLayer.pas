...
type TDataLayer = class(TStringList)
  ...
  public
    ...
    procedure LoadFromIBStream(stream:IBStream);
    procedure SaveToIBStream(stream:IBStream);
...
procedure TDataLayer.LoadFromIBStream(stream: IBStream);
VAR i,l:integer;
    buffer:TBytes;
    s:string;
begin
...
procedure TDataLayer.SaveToIBStream(stream: IBStream);
VAR i,l:integer;
    buffer:TBytes;
    s:string;
begin
